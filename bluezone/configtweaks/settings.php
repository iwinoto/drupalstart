...
if (isset($services_json)) {
  if (isset($services_json["user-provided"][0]["credentials"])) {
    ...
    list($hostname, $port) = explode(':', $postgres_config["public_hostname"]);
    $dbname = 'compose';
  }
}
$databases = array (
...
$conf['site_slogan'] = 'Don\'t be a droop, Drupal it! (' . $application_json["application_uris"] . '; ' . $application_json["name"] . ')';
